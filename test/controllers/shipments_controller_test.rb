...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference('Shipment.count') do
      post shipments_url, params: { shipment: { comments: @shipment.comments, fecha_envio_at: @shipment.fecha_envio_at } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { comments: @shipment.comments, fecha_envio_at: @shipment.fecha_envio_at } }
